...
parser.add_argument(
    '--experiment_root', type=common.writeable_directory,
    default="experiment",
...
def main():
    ...
    # if not args.image_root:
        # parser.print_help()
        # log.error("You did not specify the required `image_root` argument!") # # 11-3 commenting out because we are not using image_root(or image_root is "" and we are
        # specifying the full path in train.csv instead
        # sys.exit(1)
